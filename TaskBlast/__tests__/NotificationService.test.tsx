...
const mockScheduleNotificationAsync = (global as any).mockNotifications.scheduleNotificationAsync;
const mockCancelScheduledNotificationAsync = (global as any).mockNotifications.cancelScheduledNotificationAsync;
const mockCancelAllScheduledNotificationsAsync = (global as any).mockNotifications.cancelAllScheduledNotificationsAsync;
const mockGetAllScheduledNotificationsAsync = (global as any).mockNotifications.getAllScheduledNotificationsAsync;
const mockGetPermissionsAsync = (global as any).mockNotifications.getPermissionsAsync;
const mockRequestPermissionsAsync = (global as any).mockNotifications.requestPermissionsAsync;
const mockSetNotificationHandler = (global as any).mockNotifications.setNotificationHandler;
...
describe('Notification Service', () => {
  ...
  describe('Canceling Notifications', () => {
    ...
    it('should cancel all task notifications', async () => {
      ...
      expect(mockCancelScheduledNotificationAsync).toHaveBeenCalledWith('notif-3');
    });
    ...
    it('should cancel daily digest notifications', async () => {
      ...
      expect(mockCancelScheduledNotificationAsync).toHaveBeenCalledWith('daily-1');
    });
  });
  ...
  describe('Get Scheduled Notifications', () => {
    it('should retrieve all scheduled notifications', async () => {
      ...
      mockGetAllScheduledNotificationsAsync.mockResolvedValue(mockNotifications);
    ...
    it('should return empty array on error', async () => {
      mockGetAllScheduledNotificationsAsync.mockRejectedValue(new Error('Permission denied'));
  ...
  describe('Error Handling', () => {
    ...
    it('should handle haptic feedback errors gracefully', async () => {
      (global as any).mockAppState.setCurrentState('active');
      mockNotificationAsync.mockRejectedValue(new Error('Haptics not supported'));

      await expect(showTimerCompleteNotification('Test', false)).resolves.not.toThrow();
    });
  });
